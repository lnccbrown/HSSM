...
class TestPriorIntegration:
    ...
    def test_centered_no_parameterization_warning(self, cavanagh_test, caplog):
    ...
    def test_overparameterization_warns_under_centered(self, cavanagh_test, caplog):
...
class TestPriorParameterizationUnit:
    ...
    def test_check_user_priors_unit(self):
    ...
    def test_check_user_priors_scalar_sigma_warns_about_build_failure(self):
    ...
    def test_overparameterization_check_unit(self):
