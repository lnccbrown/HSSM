...
class TestVICompatUnit:
    """Unit tests for VI compatibility shim behavior and restoration."""

    def test_static_shape_vi_params_makes_params_static(self):
        model = _tiny_model()
    ...
    def test_static_shape_vi_params_restores_originals(self):
        originals = {
    ...
    def test_static_shape_vi_params_restores_on_error(self):
    ...
    def test_coerce_approx_params_to_numpy(self):
