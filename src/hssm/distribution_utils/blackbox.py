...
def make_blackbox_op(logp: Callable, data_dim: int = 2) -> Op:
    ...
    if data_dim == 0:
        ...
        class BlackBoxOp_No_Data(Op):  # pylint: disable=W0223
            ...
            def make_node(self, *dist_params):
                ...
                Also specifies the output types in a list, then feed them
                to the Apply node.
        ...
        blackbox_op_no_data: Op = BlackBoxOp_No_Data()
        return blackbox_op_no_data
